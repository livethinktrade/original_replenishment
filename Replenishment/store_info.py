...
from Sales_Report.Reports.reports_table import reports_table
...
class Replenishment():
    ...
    def sales_report(self):
        ...
        sales_report, item_sales_rank, sales_sql_YTD_Mask, sales_sql_YTD_WoMask, sales_report_len, on_hand, no_scan = reports_table(
